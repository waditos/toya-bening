import{r as c,e as i,f as R,a as t,A as L,w as S,F as g,m,d as b,t as n,c as u,q as E,s as V,l as r,n as M}from"./index-Ckhgz3da.js";import{r as j,u as G}from"./api-wlwoydww.js";const U={class:"step-card"},H={class:"step-body"},J={style:{display:"flex",gap:"8px","margin-bottom":"12px"}},Y=["value"],O=["value"],q={key:0,class:"loading-dots"},K={key:1,class:"error-msg"},Q={class:"rekap-stats"},W={class:"stat-card"},X={class:"stat-value"},Z={class:"stat-card"},tt={class:"stat-value"},et={class:"stat-card"},at={class:"stat-value"},st={class:"stat-card",style:{background:"#D1FAE5"}},nt={class:"stat-value",style:{color:"#065F46"}},lt={class:"stat-card",style:{background:"#FEE2E2"}},ot={class:"stat-value",style:{color:"#DC2626"}},it={class:"stat-card"},rt={class:"stat-value",style:{"font-size":"20px"}},dt={style:{overflow:"auto",flex:"1","border-radius":"10px",border:"1px solid #E2E8F0"}},ut={class:"rekap-table",style:{"min-width":"600px"}},pt={style:{"text-align":"center"}},ct={style:{"font-family":"monospace","font-size":"11px"}},ht={style:{"font-size":"13px"}},vt={style:{"text-align":"center"}},gt={style:{"text-align":"center","font-weight":"600"}},yt={style:{"text-align":"center","font-weight":"600"}},xt={style:{"text-align":"right","font-weight":"600","font-family":"monospace"}},mt=["onClick"],bt={key:1,style:{"font-size":"14px",color:"var(--success)","font-weight":"700"}},ft={key:3,style:{"text-align":"center",padding:"30px",color:"var(--text-secondary)"}},wt={width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5",style:{"margin-bottom":"8px"}},Dt={__name:"HalamanRekap",setup(kt){const z=V(),{reset:F}=E(),y=new Date,h=c(y.getMonth()+1),v=c(y.getFullYear()),l=c([]),p=c(!1),d=c(""),f=["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"],T=u(()=>{const s=y.getFullYear();return[s-2,s-1,s,s+1]}),x=u(()=>l.value.reduce((s,e)=>s+(parseFloat(e.MeterBaru)||0),0).toFixed(1)),$=u(()=>l.value.length===0?"0":(parseFloat(x.value)/l.value.length).toFixed(1)),w=u(()=>l.value.filter(s=>s.StatusBayar==="Lunas").length),k=u(()=>l.value.filter(s=>s.StatusBayar!=="Lunas").length),_=u(()=>l.value.reduce((e,a)=>e+(parseFloat(a.Tagihan)||0),0).toLocaleString("id-ID"));function B(s){return(parseFloat(s)||0).toLocaleString("id-ID")}async function A(s,e){try{const a=await G(s,"Lunas");a.success?l.value[e].StatusBayar="Lunas":d.value=a.error||"Gagal memperbarui status"}catch{d.value="Gagal terhubung ke server"}}async function C(){p.value=!0,d.value="";try{const s=await j(String(h.value),String(v.value));s.success?l.value=s.data||[]:d.value=s.error||"Gagal memuat data"}catch{d.value="Gagal terhubung ke server"}p.value=!1}function N(){const s=l.value.map((o,D)=>{const P=o.StatusBayar==="Lunas"?"Lunas":"Belum";return`<tr>
